...
from PySide6.QtWidgets import (
    ...
    QHeaderView, QDateEdit, QSpinBox, QInputDialog
)
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("CHAP1 — Compte-rendus Harmonisés et Assistance au Pilotage")
    ...
    def _live_start(self):
        ...
        wav_path = None
        if self.want_wav:
            folder = TRANSCRIPTS_DIR.parent / "audio" / f"{th}_{pr}"
    ...
    def _live_stop(self):
        ...
        folder = TRANSCRIPTS_DIR / f"{th}_{pr}"
        folder.mkdir(parents=True, exist_ok=True)
