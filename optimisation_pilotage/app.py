...
def main():
    ...
    tw1 = QWidget(); l1 = QVBoxLayout(tw1); l1.addWidget(QLabel('Live (Mix)')); tabs.addTab(tw1, 'Live (Mix)')
    tw2 = QWidget(); l2 = QVBoxLayout(tw2); l2.addWidget(QLabel('CR & ToDo')); tabs.addTab(tw2, 'CR & ToDo')
    tw3 = QWidget(); l3 = QVBoxLayout(tw3); l3.addWidget(QPushButton('Export : Excel (CR, ToDo, ToDo_Global)'))
    l3.addWidget(QPushButton('Export : Excel (CR formatés — tableaux)')); tabs.addTab(tw3, 'Export')
