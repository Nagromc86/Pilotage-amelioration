...
def _fetch_global_todos():
    ...
    cols = ["ToDoID","Thématique (Domaine)","Projet (Sujet)","MeetingID","Date réunion","Titre réunion","Action","Acteur","Échéance","Statut","Créé"]
    out = []
    for r in rows:
        out.append({
            "ToDoID": r[0],
